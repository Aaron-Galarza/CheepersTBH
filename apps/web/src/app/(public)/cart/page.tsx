...
export default function CartPage() {
  ...
  return (
    <div className="cart-bg min-h-screen pb-40">
      <div className="mx-auto mb-10 mt-10 max-w-[700px] rounded-2xl bg-white/80 p-6 shadow-sm max-md:mt-[120px] max-md:mx-4"
